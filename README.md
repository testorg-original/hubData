...
# hubData <a href="https://testorg-rename.github.io/hubData/"><img src="man/figures/logo.png" align="right" height="131" alt="hubData website" /></a>
...
[![R-CMD-check](https://github.com/testorg-rename/hubData/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/testorg-rename/hubData/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
...
remotes::install_github("testorg-rename/hubData")
```
