...
Other hubverse tools, designed for data validation, [ensemble building](https://testorg-rename.github.io/hubEnsembles/), [visualization](https://github.com/testorg-rename/hubVis), etc..., all are designed with the "promises" implicit in the data format specified by `model_out_tbl`. For example, [the `hubEnsembles::linear_pool()` function ](https://testorg-rename.github.io/hubEnsembles/reference/linear_pool.html) both accepts as input and returns as output `model_out_tbl` objects.
